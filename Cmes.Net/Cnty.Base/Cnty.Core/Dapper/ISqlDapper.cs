...
namespace Cnty.Core.Dapper
{
    public interface ISqlDapper
    {
        ...
        T ExecuteScalar<T>(string sql, object param = null, int? commandTimeout = null, CommandType? commandType = null, bool beginTransaction = false);
         int Execute(string sql, object param = null, int? commandTimeout = null, CommandType? commandType = null);
         void BatchInsert(DataTable dt, string tableName, Dictionary<string, string> columnNames);
