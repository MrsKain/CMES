...
namespace Cnty.Core.Services
{
    ...
    public static class Logger
    {
        ...
        private static void Add(LoggerType loggerType, string requestParameter, string responseParameter, string ex, LoggerStatus status)
        {
            ...
            try
            {
                ...
                log = new Sys_Log()
                {
                    ...
                    Success = (int)status,
                    CreateID =userInfo.Id.ToString(),
                    CreateDate=DateTime.Now,
                    Creater= userInfo.UserTrueName,
                    Modifier= userInfo.UserTrueName,
                    ModifyDate=DateTime.Now,
                    ModifyID=userInfo.Id.ToString()
                };
        ...
        private static DataTable CreateEmptyTable()
        {
            ...
            queueTable.Columns.Add("User_Id", typeof(string));
            queueTable.Columns.Add("UserName", typeof(string));
            queueTable.Columns.Add("Role_Id", typeof(string));
            return queueTable;
        }
