...
namespace Cnty.Core.BaseProvider
{
    public interface IRepository<TEntity> where TEntity : BaseEntity,new()
    {
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        List<TFind> Find<TFind>(Expression<Func<TFind, bool>> predicate) where TFind : BaseEntity;

        Task<TFind> FindAsyncFirst<TFind>(Expression<Func<TFind, bool>> predicate) where TFind : BaseEntity;

        Task<TEntity> FindAsyncFirst(Expression<Func<TEntity, bool>> predicate);

        Task<List<TFind>> FindAsync<TFind>(Expression<Func<TFind, bool>> predicate) where TFind : BaseEntity;
        ...
        bool Exists<TExists>(Expression<Func<TExists, bool>> predicate) where TExists : BaseEntity;

        Task<bool> ExistsAsync<TExists>(Expression<Func<TExists, bool>> predicate) where TExists : BaseEntity;
        ...
        IQueryable<TFind> IQueryablePage<TFind>(int pageIndex, int pagesize, out int rowcount, Expression<Func<TFind, bool>> predicate, Expression<Func<TEntity, Dictionary<object, QueryOrderBy>>> orderBy, bool returnRowCount = true) where TFind : BaseEntity;
       ...
       void BulkInsert(IEnumerable<TEntity> entities, bool setOutputIdentity = false);
        ...
        IQueryable<TEntity> FromSqlInterpolated([System.Diagnostics.CodeAnalysis.NotNull] FormattableString sql);
         int DelEntity(TEntity entity, bool saveChanges = false);
        ...
        /// <returns></returns>
        TEntity GetEntity(Expression<Func<TEntity, bool>> where, Expression<Func<OrderExpression<TEntity>, object>> order = null);
        /// <summary>
        /// 获取实体集合(非删除数据)
        /// </summary>
        /// <param name="where"></param>
        ...
        /// <returns></returns>
        IEnumerable<TEntity> GetEntityList(Expression<Func<TEntity, bool>> where = null, Expression<Func<OrderExpression<TEntity>, object>> order = null, int? top = null);
        ...
        /// <param name="top"></param>
        /// <returns></returns>
        IEnumerable<TEntity> GetEntityListAll(Expression<Func<TEntity, bool>> where = null, Expression<Func<OrderExpression<TEntity>, object>> order = null, int? top = null);
        /// <summary>
        /// 更新操作
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <returns></returns>
        int UpdateEntity(Expression<Func<TEntity>> expression, Expression<Func<TEntity, bool>> where);
        /// <summary>
        /// 删除数据
        /// </summary>
        /// <param name="where"></param>
        ...
        /// <returns></returns>
        int DeleteEntity(Expression<Func<TEntity, bool>> where, bool isLogic = true);
