let viewgird = [
   {
    ...
    ,{
      ...
      component: () => import('@/views/order/vSellOrderImg.vue')
        ...
        path: '/Scada_Data_Demo',
        name: 'Scada_Data_Demo',
        component: () => import('@/views/cnty_scada/cnty_scada_collection/Scada_Data_Demo.vue')
    }    ,{
        path: '/Rgm_In_Data',
        name: 'Rgm_In_Data',
        component: () => import('@/views/rgm/cnty.rgm/Rgm_In_Data.vue')
    }]
