...
<span style="color: #000000;">                extend: gridExtend,
                ...
                editFormFileds: {"OrderType":"","TranNo":"","Qty":"","SellNo":"","Remark":"","Creater":"","CreateDate":"","ModifyDate":""<span style="color: #000000;">},
                ...
                editFormOptions: [[{"dataKey":"ordertype","title":"订单类型","required":<span style="color: #0000ff;">true</span>,"field":"OrderType","type":"select"<span style="color: #000000;">},
                              ...
                              [ {</span>"type":"text","title":"销售订单号","required":<span style="color: #0000ff;">true</span>,"field":"SellNo"},{"type":"text","title":"创建人","field":"Creater","disabled":<span style="color: #0000ff;">true</span><span style="color: #000000;">},
                ...
                searchFormFileds: {"OrderType":"","TranNo":"","SellNo":"","AuditStatus":"","AuditDate":"","Auditor":"","Creater":"","CreateDate":"","ModifyDate":""<span style="color: #000000;">},
...
<span style="color: #000000;">                searchFormOptions: [
                    ...
                    [
                        {</span>"type":"text","title":"创建人","field":"Creater"<span style="color: #000000;">},
                ...
                columns: [ <span style="color: #008000;">//</span><span style="color: #008000;">列参数为voltable组件的配置</span>
                       ...
                       {field:</span>'Creater',title:'创建人',type:'string',width:100,readonly:<span style="color: #0000ff;">true</span><span style="color: #000000;">},
...
<span style="color: #000000;">                    columns: [
                       ...
                       {field:</span>'Creater',title:'创建人',type:'string',width:130<span style="color: #000000;">},
