<template>
  ...
  <div class="bg">
    <div class="content">
      <div class="l-left">
        <div class="desc">
          <div class="title" style="margin-top: 100px;margin-left: 70px">CNTY</div>
...
export default {
  ...
  computed:{
      imgName:function(){
            let imgs = ["bimage1.jpg","bimage2.jpg","bimage3.jpg","bimage4.jpg","bimage5.jpg","bimage6.jpg","bimage7.jpg","bimage8.jpg","bimage9.jpg","bimage10.jpg","bimage11.jpg","bimage12.jpg"]
            let imgName = imgs[Math.floor(Math.random() * 12)] //进行计算随机
             imgName=require('@/assets/imgs/'+imgName+'');
            return imgName     
          }
      },
};
...
.bg {
  ...
  overflow: hidden;
  width: 100%;
  background-image: linear-gradient(135deg, #44be8c 10%, #279b8b);
}
.background{
    width:100%;  
