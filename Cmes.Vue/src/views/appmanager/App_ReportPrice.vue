    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                extend: extend,
                editFormFileds: {"Variety":"","Age":"","City":"","Price":"","Creater":"","Enable":"","CreateDate":"","AuditDate":"","ModifyDate":""},
                editFormOptions: [[{"dataKey":"pz","data":[],"title":"品种","required":true,"field":"Variety","type":"select"},
                              ...
                              [{"title":"价格","required":true,"field":"Price","type":"decimal"},
                               {"title":"上报人","field":"Creater","disabled":true},
                ...
                columns: [{field:'Id',title:'主键ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'Creater',title:'上报人',type:'string',width:100,hidden:true,readonly:true,align:'left'},
