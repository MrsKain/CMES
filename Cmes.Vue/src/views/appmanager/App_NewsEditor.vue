    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                searchFormFileds: {"Title":"","ReleaseDate":"","NewsType":"","DailyRecommend":"","Enable":"","Creater":""},
                searchFormOptions: [[{"title":"标题","field":"Title"},{"dataKey":"news","title":"新闻类型","field":"NewsType","type":"drop"},{"dataKey":"dr","title":"内容推荐","field":"DailyRecommend","type":"drop"}],[{"title":"发布时间","field":"ReleaseDate","type":"datetime"},{"dataKey":"enable","title":"是否启用","field":"Enable","type":"drop"},{"title":"发布人","field":"Creater"}]],
                columns: [{field:'Id',title:'主键ID',type:'int',width:80,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'Creater',title:'发布人',type:'string',width:130,hidden:true,readonly:true,align:'left'},
