...
<script>
    import extend from "@/extension/order/SellOrder2.js";
    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                extend: extend,
                editFormFields: {"OrderType":"","TranNo":"","Qty":"","SellNo":"","Remark":"","Creater":"","CreateDate":"","ModifyDate":""},
                ...
                searchFormFields: {"OrderType":"","TranNo":"","SellNo":"","AuditStatus":"","AuditDate":"","Auditor":"","Creater":"","CreateDate":"","ModifyDate":""},
                searchFormOptions: [[{"title":"运单号","field":"TranNo"},{"title":"销售订单号","field":"SellNo"},{"dataKey":"ordertype","title":"订单类型","field":"OrderType","type":"select"}],[{"dataKey":"audit","title":"审核状态","field":"AuditStatus","type":"select"},{"title":"审核时间","field":"AuditDate","type":"datetime"},{"title":"审核人","field":"Auditor"}],[{"title":"创建人","field":"Creater"},{"title":"创建时间","field":"CreateDate","type":"datetime"},{"title":"修改时间","field":"ModifyDate","type":"datetime"}]],
                columns: [{field:'Order_Id',title:'Id',type:'string',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'SellNo',title:'销售订单号',type:'string',width:170,require:true,align:'left'},
