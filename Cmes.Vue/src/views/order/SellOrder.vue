    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                extend: extend,
                editFormFields: {"OrderType":"","TranNo":"","Qty":"","Creater":"","SellNo":"","Remark":"","CreateDate":"","ModifyDate":""},
                ...
                searchFormFields: {"OrderType":"","TranNo":"","SellNo":"","Qty":[null,null],"AuditStatus":"","AuditDate":"","Auditor":"","Creater":"","CreateDate":""},
                searchFormOptions: [[{"title":"运单号","field":"TranNo"},{"title":"销售订单号","field":"SellNo"},{"dataKey":"ordertype","data":[],"title":"订单类型","field":"OrderType","type":"select"}],[{"dataKey":"audit","data":[],"title":"审核状态","field":"AuditStatus","type":"select"},{"title":"审核时间","field":"AuditDate","type":"datetime"},{"title":"审核人","field":"Auditor"}],[{"title":"创建人","field":"Creater"},{"title":"创建时间","field":"CreateDate","type":"datetime"},{"title":"销售数量","field":"Qty","type":"range"}]],
